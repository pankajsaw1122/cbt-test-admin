...
getCategoryList(data) {
  return this.http.get(this.apiUrl + 'categ/getCategList?id=' + data, {
    headers: new HttpHeaders().set('Authorization', localStorage.getItem('authToken'))
  }).pipe(map((res) => res), catchError(this.handleError));
}
...
getExamResult(data) {
  return this.http.get(this.apiUrl + 'result/getResultData?examId=' + data.examId + '&classes=' + data.classes, {
    headers: new HttpHeaders().set('Authorization', localStorage.getItem('authToken'))
  }).pipe(map((res) => res), catchError(this.handleError));
}

getImagePath(data) {
  return this.http.post(this.apiUrl + 'upload/uploadImage', data, {
    headers: new HttpHeaders().set('Authorization', localStorage.getItem('authToken'))
  }).pipe(map((res) => res), catchError(this.handleError));
}
}